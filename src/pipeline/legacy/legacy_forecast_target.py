...
from models.legacy.legacy_target_forecast_with_regressors import forecast_target_with_regressors
from src.models.legacy.legacy_target_forecast import forecast_target
